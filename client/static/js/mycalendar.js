                    ...
                    MyCalendar.calendarsRepository.find({}).done(function (calendars) {
                        ...
                        calendars.forEach(function (calendar) {
                            ...
                            calendarItem.find('.calendar-name').on('input', function (ev) {
                                ev.preventDefault();
                                ev.stopPropagation();
                                MyCalendar.calendarsRepository.update(calendar.getRefId(), { name: calendarItem.find('.calendar-name').val() }).done(function (json) {
                                    calendar.name = json.name;
                                });
                            });
                            ...
                            calendarItem.click(function () {
                                MyCalendar.UI.PanelHost.getInstance().pushPanel(new MyCalendar.UI.Panels.CalendarManagerPanel(calendar));
                            });
                        });
                    });
                };
